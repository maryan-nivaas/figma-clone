...
#define CONFIGURE_ARGS " '--prefix=/Users/nivaasd/My works/figma-clone/.local/pgsql' '--without-readline' '--without-zlib' '--without-icu'"
...
#define PG_VERSION_STR "PostgreSQL 16.6 on aarch64-apple-darwin24.6.0, compiled by Apple clang version 17.0.0 (clang-1700.6.3.2), 64-bit"
